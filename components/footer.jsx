...
const links = [
  { href: "/", label: "Nikola Smejkalová" },
  { href: "/recenze", label: "recenze" },
  { href: "/blog", label: "transformační metody" },
...
export default function Footer() {
  return (
    <footer className="mx-auto max-w-screen-2xl px-4 md:px-8 bg-white pt-4 sm:pt-10 lg:pt-12">
